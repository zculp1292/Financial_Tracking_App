...
class Sign_Up_One_Form(object):
    def setupUi(self, Form):
        ...
        self.le_first_name = QtWidgets.QLineEdit(parent=Form)
        ...
        self.le_last_name = QtWidgets.QLineEdit(parent=Form)
        ...
        self.le_dob = QtWidgets.QLineEdit(parent=Form)
        ...
        self.le_password_one = QtWidgets.QLineEdit(parent=Form)
        ...
        self.le_password_two = QtWidgets.QLineEdit(parent=Form)
        ...
        self.btn_next_step = QtWidgets.QPushButton(parent=Form)
        self.btn_next_step.setObjectName("btn_next_step")
        self.horizontalLayout_7.addWidget(self.btn_next_step)
        self.label_username_invalid = QtWidgets.QLabel(parent=Form)
